...
public class PrinterController : ControllerBase
{
    ...
    public IActionResult SendSATOCommand(PostRFIDLabeldto postRFIDLabeldto)
    {
        try
        {
            ...
            string stringResult = $@"
                ...
                ^FO880,145^A0N,30,30^FD{DateTime.Now:dd-MM-yy}^FS
